...
submit_simulation "${PROJECT_DIR}/data/241010_FoldingUponBinding/output/CD28-G/241215-NewUW3/CD28_general_equilibrated.cif" \
                "CD28-G-NewUW3" \
                "${PROJECT_DIR}/data/241010_FoldingUponBinding/output/CD28-G/241222-NewUW3" \
                True
