...
def run(
    ...
    D_GAP = 2 # might tune this, describes distance where we expect no interaction
    D_IDR = 8 # might tune this
    D_BINDER = 3 # get this from PDB or vanilla MD
    UPPER_WALL_AT = (D_GAP + D_IDR + D_BINDER) - 1
