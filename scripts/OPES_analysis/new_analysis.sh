...
python analysis.py --system ASYN-A --date 241122 --project 241010_FoldingUponBinding --recompute $RECOMPUTE
python analysis.py --system ASYN-G --date 241122 --project 241010_FoldingUponBinding --recompute $RECOMPUTE
python analysis.py --system CD28-A --date 241122 --project 241010_FoldingUponBinding --recompute $RECOMPUTE
python analysis.py --system CD28-B --date 241122 --project 241010_FoldingUponBinding --recompute $RECOMPUTE
python analysis.py --system CD28-G --date 241122 --project 241010_FoldingUponBinding --recompute $RECOMPUTE
python analysis.py --system CD28-P --date 241122 --project 241010_FoldingUponBinding --recompute $RECOMPUTE
python analysis.py --system P53-1 --date 241122 --project 241010_FoldingUponBinding --recompute $RECOMPUTE
python analysis.py --system P53-2 --date 241122 --project 241010_FoldingUponBinding --recompute $RECOMPUTE
python analysis.py --system P53-E --date 241122 --project 241010_FoldingUponBinding --recompute $RECOMPUTE
python analysis.py --system SUMO-1A --date 241122 --project 241010_FoldingUponBinding --recompute $RECOMPUTE
python analysis.py --system SUMO-1C --date 241122 --project 241010_FoldingUponBinding --recompute
