# python analysis.py --system CD28-G-UW5P2 --date 241118 --project 241010_FoldingUponBinding
# python analysis.py --system CD28-G-UW5P4 --date 241118 --project 241010_FoldingUponBinding
