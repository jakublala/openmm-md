...
submit_simulation "${PROJECT_DIR}/data/241010_FoldingUponBinding/output/ASYN-A/241128-MetaD/A-synuclein_alpha_equilibrated.pdb" \
                "ASYN-A" \
                56 \
                0.24 \
                0.05 \
...
submit_simulation "${PROJECT_DIR}/data/241010_FoldingUponBinding/output/ASYN-G/241128-MetaD/A-synuclein_general_equilibrated.pdb" \
                "ASYN-G" \
                12 \
                0.31 \
                0.25 \
...
submit_simulation "${PROJECT_DIR}/data/241010_FoldingUponBinding/output/CD28-A/241128-MetaD/CD28_alpha_equilibrated.pdb" \
                "CD28-A" \
                40 \
                0.18 \
                0.02 \
...
submit_simulation "${PROJECT_DIR}/data/241010_FoldingUponBinding/output/CD28-B/241128-MetaD/CD28_beta_equilibrated.pdb" \
                "CD28-B" \
                40 \
                0.23 \
                0.01 \
...
submit_simulation "${PROJECT_DIR}/data/241010_FoldingUponBinding/output/CD28-P/241128-MetaD/CD28_partial_equilibrated.pdb" \
                "CD28-P" \
                48 \
                0.18 \
                0.02 \
...
submit_simulation "${PROJECT_DIR}/data/241010_FoldingUponBinding/output/P53-1/241128-MetaD/p53_1_equilibrated.pdb" \
                "P53-1" \
                40 \
                0.12 \
                0.01 \
...
submit_simulation "${PROJECT_DIR}/data/241010_FoldingUponBinding/output/P53-2/241128-MetaD/p53_2_equilibrated.pdb" \
                "P53-2" \
                40 \
                0.17 \
                0.01 \
...
submit_simulation "${PROJECT_DIR}/data/241010_FoldingUponBinding/output/P53-E/241128-MetaD/p53_end_equilibrated.pdb" \
                "P53-E" \
                40 \
                0.27 \
                0.05 \
...
submit_simulation "${PROJECT_DIR}/data/241010_FoldingUponBinding/output/SUMO-1A/241128-MetaD/sumo1_equilibrated.pdb" \
                "SUMO-1A" \
                52 \
                0.18 \
                0.06 \
...
submit_simulation "${PROJECT_DIR}/data/241010_FoldingUponBinding/output/SUMO-1C/241128-MetaD/sumo1c_equilibrated.pdb" \
                "SUMO-1C" \
                32 \
                0.23 \
                0.01 \
